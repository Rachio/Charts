...
extension MutableCollection where Self: BidirectionalCollection {
  ...
  internal mutating func _reverse(
    subrange: Swift.Range<Index>, until limit: Index
  ) -> (Index, Index) {
  ...
  @inlinable
  public mutating func reverse(subrange: Swift.Range<Index>) {
...
extension MutableCollection {
  ...
  internal mutating func _swapNonemptySubrangePrefixes(
    _ lhs: Swift.Range<Index>, _ rhs: Swift.Range<Index>
  ) -> (Index, Index) {
    assert(!lhs.isEmpty)
    assert(!rhs.isEmpty)
